...
python -m reset_sync
# или
python reset_sync.py
```

## Запуск в VSCode

Для удобства в проекте создан файл `.vscode/launch.json`, который позволяет запускать приложение через отладчик VSCode:

- "Python: Module" - запускает `src.main` как модуль
- "Python: Reset Sync" - запускает `reset_sync` как модуль
...
Скрипт корректно обрабатывает следующие форматы дат Microsoft To Do:
- `2025-10-05T13:00Z`
- `2025-10-05T13:00:00.000Z`
- `2025-10-05T13:00:00.0000Z`
- `2025-10-05T13:00:00.00000Z`
- `2025-10-05T13:00:0.000000Z`

При преобразовании в часовой пояс Сахалинска (UTC+11) дата `2025-10-05T13:00:00Z` становится `2025-10-06` (следующий день).